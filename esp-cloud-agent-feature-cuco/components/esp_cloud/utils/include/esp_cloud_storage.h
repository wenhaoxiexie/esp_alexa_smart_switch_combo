...
/** Intialisa ESP Cloud Storage
 *
 * This API is internally called by esp_cloud_init(). Applications may call this
 * only if access to the ESP Cloud storage is required before esp_cloud_init().
 *
...
/** Get data from ESP Cloud storage
 *
 * This API will return NULL terminated keys/certificates
 * from the ESP Cloud storage.
 *
