 ...
 *
 * Code taken from: https://github.com/shahpiyushv/json_generator
 */
 ...
 * The API json_add_to_long_string() must be used to add to this string and the API
 * json_end_long_string() must be used to terminate it (i.e. add the ending quotes).
 *
 * \note This must be called between json_start_object()/json_push_object()
 * and json_end_object()/json_pop_object()
 *
 ...
 * added after that
 */
int json_obj_start_long_string(json_str_t *jstr, char *name, char *val);
 ...
 * added after that
 */
int json_arr_start_long_string(json_str_t *jstr, char *val);

/** Add to a JSON Long string
 *
 * This extends the string initialised by json_obj_start_long_string() or
 * json_arr_start_long_string(). After the entire string is created, it should be terminated
 * with json_end_long_string().
 *
 * \param[in] jstr Pointer to the \ref json_str_t structure initilised by json_str_start()
 ...
 * added after that
 */
int json_add_to_long_string(json_str_t *jstr, char *val);

/** End a JSON Long string
 *
 * This ends the string initialised by json_obj_start_long_string() or
 * json_arr_start_long_string() by adding the ending quotes.
 *
 * \param[in] jstr Pointer to the \ref json_str_t structure initilised by json_str_start()
 *
 *
 ...
 * added after that
 */
int json_end_long_string(json_str_t *jstr);
